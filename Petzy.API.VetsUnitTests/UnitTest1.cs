...
namespace PetzyVet.API.Tests.Controllers
{
    ...
    public class VetsControllerTests
    {
        ...
        public void GetAllVets_Returns_Ok_With_VetCards()
        {
            ...
            {
                new Vet { VetId = 1, FName = "John", LName = "Doe", Speciality = "Dentist", Phone = "1234567890" },
                new Vet { VetId = 2, FName = "Jane", LName = "Smith", Speciality = "Surgeon", Phone = "0987654321" }
            };
        ...
        [TestMethod]
        public void GetVetById_With_Valid_Id_Returns_Ok_With_VetProfileDTO()
        {
            // Arrange
            int vetId = 1;
            var vet = new Vet { VetId = vetId, FName = "John", LName = "Doe", Speciality = "Dentist", Phone = "1234567890" };
            ...
            Assert.IsNotNull(contentResult);
            Assert.IsNotNull(contentResult.Content);
            Assert.AreEqual("John Doe", contentResult.Content.Name);
            Assert.AreEqual("Dentist", contentResult.Content.Speciality);
        }

        [TestMethod]
        public void AddVet_With_Valid_Vet_Returns_Ok()
        {
            // Arrange
            var vet = new Vet { *//* Initialize Vet properties *//* };
        ...
        [TestMethod]
        public void UpdateVet_With_Valid_Id_And_Vet_Returns_Ok()
        {
            // Arrange
            int vetId = 1;
        ...
        [TestMethod]
        public void DeleteVet_With_Valid_Id_Returns_Ok()
        {
            // Arrange
            int vetId = 1;
            var vet = new Vet { VetId = vetId, *//* Initialize other Vet properties *//* };
        ...
        [TestMethod]
        public void EditStatus_With_Valid_Id_And_Status_Returns_Ok()
        {
            // Arrange
            int vetId = 1;
            bool status = true;
        ...
        [TestMethod]
        public void GetVetsByListOfIds_With_Valid_List_Of_Ids_Returns_Ok_With_List_Of_VetIdNameDTO()
        {
            // Arrange
            ...
            {
                if (id == 1)
                    return new Vet { VetId = 1, FName = "John", LName = "Doe", Speciality = "Dentist", Phone = "1234567890" };
                else if (id == 2)
                    return new Vet { VetId = 2, FName = "Jane", LName = "Smith", Speciality = "Surgeon", Phone = "0987654321" };
                else
                    return null;
            });
...
namespace PetzyVet.API.Tests.Controllers
{
    ...
    public class VetsControllerTests
    {
        ...
        [TestMethod]
        public void GetAllVets_Returns_NotFound_When_No_Vets()
        {
            // Arrange
            var mockRepository = new Mock<IVetRepository>();
        ...
        // Add similar methods for UpdateVet, DeleteVet, EditStatus, and GetVetsByListOfIds with various scenarios
